...
export const ConnectionTypeSchema = withOpenApiType(
	createNamedStringLiteralUnion(
		[
			...
			[ConnectionTypes.BATTLENET, 'BATTLENET', 'Battle.net account connection'],
			[ConnectionTypes.EPIC_GAMES, 'EPIC_GAMES', 'Epic Games account connection'],
			[ConnectionTypes.FACEBOOK, 'FACEBOOK', 'Facebook account connection'],
			[ConnectionTypes.GITHUB, 'GITHUB', 'GitHub account connection'],
			[ConnectionTypes.PAYPAL, 'PAYPAL', 'PayPal account connection'],
			[ConnectionTypes.PLAYSTATION, 'PLAYSTATION', 'PlayStation Network connection'],
			[ConnectionTypes.REDDIT, 'REDDIT', 'Reddit account connection'],
			[ConnectionTypes.SPOTIFY, 'SPOTIFY', 'Spotify account connection'],
			[ConnectionTypes.STEAM, 'STEAM', 'Steam account connection'],
			[ConnectionTypes.TIKTOK, 'TIKTOK', 'TikTok account connection'],
			[ConnectionTypes.TWITCH, 'TWITCH', 'Twitch account connection'],
			[ConnectionTypes.X, 'X', 'X (Twitter) account connection'],
			[ConnectionTypes.XBOX, 'XBOX', 'Xbox account connection'],
			[ConnectionTypes.YOUTUBE, 'YOUTUBE', 'YouTube account connection'],
		] as const,
