...
import type {PolarCheckoutService} from '@fluxer/api/src/polar/services/PolarCheckoutService';
import type {PolarSubscriptionService} from '@fluxer/api/src/polar/services/PolarSubscriptionService';
import type {PolarWebhookService} from '@fluxer/api/src/polar/services/PolarWebhookService';
...
import type {E2EEService} from '@fluxer/api/src/e2ee/E2EEService';
...
export interface HonoEnv {
	Variables: {
		...
		polarCheckoutService: PolarCheckoutService;
		polarSubscriptionService: PolarSubscriptionService;
		polarWebhookService: PolarWebhookService;
